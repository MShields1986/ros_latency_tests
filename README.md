...
The plot below shows a single hop pub → sub latency for:
...
<img src="https://github.com/MShields1986/ros_latency_tests/blob/main/img/violin_all.png" width=80% height=80%>
